...
export const metadata: Metadata = {
  title: { absolute: 'Colombia Stem Cell Therapy Guide: BioXcellerator, Medellin Clinics' },
  alternates: { canonical: 'https://vitalityscout.com/guides/colombia-stem-cell-guide' },
