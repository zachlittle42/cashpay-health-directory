...
export const metadata: Metadata = {
  title: { absolute: 'Quest Diagnostics vs Labcorp Prices: Self-Pay From $29' },
  alternates: { canonical: 'https://vitalityscout.com/guides/quest-vs-labcorp-pricing' },
  description: 'Quest Diagnostics vs Labcorp prices for self-pay lab tests: both start near $29 online. Compare questhealth.com and Labcorp OnDemand on panels, sites, speed.',
};
