...
const URL = 'https://vitalityscout.com/guides/tirzepatide-cost';
const SERVICE = 'tirzepatide-program';
...
export const metadata: Metadata = {
  title: {
    ...
    absolute:
      mi.n > 0
        ? `Tirzepatide Cost: ${medianLabel}/mo Median (2026 Verified Prices)`
        : 'Tirzepatide Cost (2026): Verified Monthly Program Prices',
  },
  alternates: { canonical: URL },
  description:
    `Verified tirzepatide programs with the medication included run a median of ${medianLabel}/mo across the ${mi.n} clinics that publish a monthly price. ` +
...
const FAQ_ITEMS = [
  {
    question: 'How much does tirzepatide cost per month?',
    answer:
      `Across the ${mi.n} clinics we found that publish a monthly tirzepatide-program price with the medication included, the median is ${medianLabel}/mo, ranging from ${lowLabel} to ${highLabel}/mo. ` +
  ...
  },
  {
    ...
    answer:
      `Every price on this page is a cash-pay, self-pay number. These programs bill you directly, not insurance, so the median of ${medianLabel}/mo with the medication included is what tirzepatide costs without insurance at the ${mi.n} clinics that publish a price. ` +
      'Coverage varies and most plans do not cover compounded tirzepatide, so the cash price is often the real out-of-pocket cost either way. Confirm the current price and what it includes with the clinic.',
  },
  {
    question: 'Why is tirzepatide usually more expensive than semaglutide?',
    answer:
      'Tirzepatide programs tend to price higher because the medication itself costs the clinic more to source, and dosing escalates over time. ' +
      'As with semaglutide, the headline monthly number depends heavily on what is bundled: an all-in program folds the medication and visits into one fee, while a membership-only program bills the medication separately. ' +
      'Compare the two drugs on the all-in monthly cost for the dose you would actually take, not the sticker price alone.',
  },
  {
    question: 'What is included in a monthly tirzepatide price?',
    answer:
  ...
  {
    question: 'Is cheaper tirzepatide worse?',
    answer:
...
export default function TirzepatideCostPage() {
  const rows = getGlp1ServiceRows(SERVICE);

  const articleSchema = {
    '@context': 'https://schema.org',
    '@type': 'Article',
    headline: 'Tirzepatide Cost: Verified Monthly Program Prices',
    description:
      'Verified per-clinic monthly tirzepatide program prices, quoted from clinic websites and dated.',
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Tirzepatide Cost', item: URL },
    ],
  };
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <SidebarShell>
        ...
        <nav className="border-b border-gray-200 px-4 py-3 text-sm" aria-label="Breadcrumb">
          <div className="mx-auto max-w-4xl text-gray-500">
            ...
            <span className="text-gray-700">Tirzepatide Cost</span>
          </div>
        </nav>
        ...
        <section className="bg-gradient-to-b from-blue-50 to-white px-4 py-10">
          <div className="mx-auto max-w-4xl">
            ...
            <h1 className="mb-4 text-4xl font-bold text-gray-900">
              Tirzepatide Cost: What Monthly Programs Actually Run
            </h1>
            {/* Direct-answer lead — <= 80 words, leads with the computed median */}
            <p className="text-lg text-gray-700">
              Verified tirzepatide programs with the medication included run a{' '}
        ...
        <article className="mx-auto max-w-4xl px-4 py-10">
          ...
          {mi.n >= 3 && (
            <div className="mb-8 rounded-lg border border-gray-200 bg-gray-50 p-5 space-y-2">
              <p className="text-lg font-semibold text-gray-900">
                Verified tirzepatide program cost: {medianLabel}/mo median{' '}
          ...
          <h2 className="mb-2 text-2xl font-bold text-gray-900">Verified tirzepatide prices by clinic</h2>
          <p className="mb-4 text-gray-600">
            Clinics with a monthly tirzepatide-program price published on their own website. Each row
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-5 text-sm text-gray-700 space-y-2">
            ...
            <p>
              ...
              tirzepatide-program prices with the medication included: one representative (cheapest)
            ...
            <p className="text-gray-500">
              Prices change and this is not medical advice. Tirzepatide requires a licensed prescriber,
          ...
          <div className="mt-12 rounded-lg border border-gray-200 bg-gray-50 p-6">
            ...
            <ul className="space-y-1 text-sm text-blue-700">
              ...
              <li><Link href="/guides/mounjaro-vs-ozempic" className="hover:underline">Mounjaro vs Ozempic: how tirzepatide and semaglutide compare</Link></li>
            </ul>
          </div>
          ...
          <div className="mt-8 rounded-lg border border-gray-300 bg-gray-100 p-6">
            ...
            <p className="text-sm text-gray-700">
              ...
              from clinic websites, are estimates, and change without notice. Tirzepatide is a
      ...
      <SubjectiveBanner family="tirzepatide" />
    </main>
  );
}
