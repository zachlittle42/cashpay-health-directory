...
export const metadata: Metadata = {
  title: { absolute: 'Hair Transplant Recovery Timeline: Day-by-Day Guide (2025)' },
  alternates: { canonical: 'https://vitalityscout.com/guides/hair-transplant-recovery-timeline' },
