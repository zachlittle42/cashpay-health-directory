...
export const metadata: Metadata = {
  title: { absolute: 'Best Online TRT Clinics Compared (2025): Fountain, Marek, TRT Nation' },
  alternates: { canonical: 'https://vitalityscout.com/guides/best-online-trt-clinics' },
