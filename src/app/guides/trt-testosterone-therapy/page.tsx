...
export const metadata: Metadata = {
  title: { absolute: 'TRT Guide: Complete Testosterone Replacement Therapy Explained (2025)' },
  alternates: { canonical: 'https://vitalityscout.com/guides/trt-testosterone-therapy' },
