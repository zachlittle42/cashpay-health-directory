...
export const metadata: Metadata = {
  title: { absolute: 'How Many Hair Grafts Do I Need? Complete Guide & Calculator (2025)' },
  alternates: { canonical: 'https://vitalityscout.com/guides/hair-transplant-grafts-guide' },
