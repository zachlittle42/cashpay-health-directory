    ...
    <footer className="border-t border-gray-200 bg-gray-50">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-6">
          ...
          <div>
            <h3 className="text-sm font-semibold text-gray-900 mb-4">Healthcare Resources</h3>
            <ul className="space-y-2 text-sm">
              <li><Link href="/insurance" className="text-gray-600 hover:text-blue-600">Insurance Companies</Link></li>
              <li><Link href="/pharma" className="text-gray-600 hover:text-blue-600">Pharma Companies</Link></li>
              <li><Link href="/drug_registry" className="text-gray-600 hover:text-blue-600">Drug Registries</Link></li>
            </ul>
          </div>
        </div>
